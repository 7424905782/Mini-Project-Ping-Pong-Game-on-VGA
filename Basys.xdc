...
## Switches
set_property PACKAGE_PIN V17 [get_ports {i_P1_diff[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_P1_diff[0]}]
set_property PACKAGE_PIN V16 [get_ports {i_P1_diff[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_P1_diff[1]}]
...
set_property PACKAGE_PIN T1 [get_ports {i_P2_diff[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_P2_diff[0]}]
set_property PACKAGE_PIN R2 [get_ports {i_P2_diff[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_P2_diff[1]}]
...
##7 segment display
set_property PACKAGE_PIN W7 [get_ports {o_seven_seg[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_seven_seg[0]}]
set_property PACKAGE_PIN W6 [get_ports {o_seven_seg[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_seven_seg[1]}]
set_property PACKAGE_PIN U8 [get_ports {o_seven_seg[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_seven_seg[2]}]
set_property PACKAGE_PIN V8 [get_ports {o_seven_seg[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_seven_seg[3]}]
set_property PACKAGE_PIN U5 [get_ports {o_seven_seg[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_seven_seg[4]}]
set_property PACKAGE_PIN V5 [get_ports {o_seven_seg[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_seven_seg[5]}]
set_property PACKAGE_PIN U7 [get_ports {o_seven_seg[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_seven_seg[6]}]
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports i_Start]						
...
set_property PACKAGE_PIN U17 [get_ports i_Switch_4]						
